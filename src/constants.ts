...
export const FACTORY_ADDRESS: { [chainId: number]: string } = {
  ...
  [ChainId.ETC]: "0x545eE5B6f85A68143dFA943F3f246B611e692aDc",

  // [ChainId.ETC]: coreETC.factory
...
export const ROUTER_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.ETC]: "0x4ca8E2AfD670b9286880f4Cb4F13a9693F5dd315"
...
export const STAKING_REWARDS_FACTORY_ADDRESS: { [chainId: number]: string } = {
  ...
  [ChainId.ETC]: '0x0000000000000000000000000000000000001234'
...
export const INIT_CODE_HASH: { [chainId: number]: string } = {
  ...
  [ChainId.ETC]: '0x141a483792dc584f5a133b68a691d38c1d495e265e564f85ed710d00454d877d' // cybermint
...
const PERMISSIVE_MULTICALL_ADDRESS: { [chainId: number]: string } = {
  ...
  [ChainId.ETC]: '0x5A3546a4b224Aa98dD71Deef7BF760d30388ea08'
