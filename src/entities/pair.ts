...
let PAIR_ADDRESS_CACHE: {
  ...
  [RoutablePlatform.Etcswap.name]: {
    ...INITIAL_CACHE_STATE
  },
  [RoutablePlatform.Hebeswap.name]: {
    ...INITIAL_CACHE_STATE
  }
}
...
export class Pair {
  ...
  constructor(
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, liquidityTokenAddress, 18, 'JellyBean-LP', 'Jellybeanswap LP Token')
