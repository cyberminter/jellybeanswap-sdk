...
const Etcswap_FACTORY_ADDRESS = "0x0307cd3D7DA98A29e6Ed0D2137be386Ec1e4Bc9C";
const Hebeswap_FACTORY_ADDRESS = "0x09fafa5eecbc11C3e5d30369e51B7D9aab2f3F53";
...
const Etcswap_ROUTER_ADDRESS = "0x79Bf07555C34e68C4Ae93642d1007D7f908d60F5";
const Hebeswap_ROUTER_ADDRESS = "0xEcBcF5C7aF4c323947CFE982940BA7c9fd207e2b";
...
export class RoutablePlatform {
  ...
  public static readonly Etcswap = new RoutablePlatform(
    'Etcswap',
    { [ChainId.ETC]: Etcswap_FACTORY_ADDRESS },
    { [ChainId.ETC]: Etcswap_ROUTER_ADDRESS },
    { [ChainId.ETC]: '0xb5e58237f3a44220ffc3dfb989e53735df8fcd9df82c94b13105be8380344e52' },
    _30
  )

  public static readonly Hebeswap = new RoutablePlatform(
    'Hebeswap',
    { [ChainId.ETC]: Hebeswap_FACTORY_ADDRESS },
    { [ChainId.ETC]: Hebeswap_ROUTER_ADDRESS },
    { [ChainId.ETC]: '0xa036bc35f72d4331ca192979fb12e8a1f3260672aca44271ce35744fa5d66749' },
    _30
  )
